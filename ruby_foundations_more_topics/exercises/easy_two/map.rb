=begin
  ...
  #inject, loop, for, while, or until to iterate through the Array passed in as an argument
=end

def map(arr)
  new_array = []
  # map performs an operation based on the block
  # for each element
  # the return value of yield gets added to the new array
  arr.each { |el| new_array << yield(el) }
  new_array
end
