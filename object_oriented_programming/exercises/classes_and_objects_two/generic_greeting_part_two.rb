...
# This exercise shows the difference between a class method and an instance method.
# class methods don't concern themselves with data on instances of the class.
