...
=begin
  ...
  This is true until the class named BasicObject, which doesn't inherit from a class.
  Some classes also include modules, such as the Object class includes the Kernel module.
=end